...
export function getModelOptions(provider: LLMprovider): string[] {
  ...
  const modelsByProvider: Record<StringProvider, string[]> = {
    ...
    'bedrock': ['ai21.jamba-1-5-large-v1:0', 'ai21.jamba-1-5-mini-v1:0', 'amazon.nova-2-multimodal-embeddings-v1:0'], // https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html
    'azure': [],
